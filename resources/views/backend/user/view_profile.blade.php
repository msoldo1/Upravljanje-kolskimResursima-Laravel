        ...
        <div class="container-full">  <!-- Main content -->
            <section class="content">
                ...
                <div class="box box-widget widget-user">
                    ...
                    <div class="widget-user-header bg-black" style="background: url('{{ $user->image }}') center center;">
                        <h3 class="widget-user-username">Korisničko ime: {{ $user->name }}</h3>
                        <a href="{{ route('profile.edit') }}" style="float: right;" class="btn btn-rounded btn-success mb-5">Edit profile</a>
                        <h6 class="widget-user-desc">Tip korisnika: {{ $user->usertype }}</h6>
                        <h6 class="widget-user-desc">Tip korisnika: {{ $user->email }}</h6>
